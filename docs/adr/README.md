...
- [ADR-001: Frontend location and framework](./ADR-001-frontend-location-and-framework.md)
- [ADR-002: Frontend state ownership](./ADR-002-frontend-state-ownership.md)
- [ADR-003: Dependency restraint](./ADR-003-dependency-restraint.md)
